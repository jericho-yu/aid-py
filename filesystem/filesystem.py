...
class FileSystem:
    ...
    @staticmethod
    def new_by_relative(dir_path: str) -> 'FileSystem':
        root_path = Path('.').resolve()
        return FileSystem(root_path / dir_path)

    @staticmethod
    def new_by_abs(dir_path: str) -> 'FileSystem':
    ...
    def rename_file(self, new_filename: str, delete_repetition: bool = False) -> 'FileSystem':
